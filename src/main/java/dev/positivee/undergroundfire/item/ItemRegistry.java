...
public class ItemRegistry
{
	...
	public static final RegistryObject<BlockItem> GAS_COAL_EXTRACTOR = ITEMS.register("gas_coal_extractor", () -> new BlockItem(BlockRegistry.GAS_COAL_EXTRACTOR.get(), new Item.Properties()));
}
