...
public class BlockEntityRegistry
{
	...
	public static final RegistryObject<BlockEntityType<BlockEntityGasCoalExtractor>> GAS_COAL_EXTRACTOR = BLOCK_ENTITY_TYPE.register("gas_coal_extractor", () -> BlockEntityType.Builder.of(BlockEntityGasCoalExtractor::new, BlockRegistry.GAS_COAL_EXTRACTOR.get()).build(null));
}
