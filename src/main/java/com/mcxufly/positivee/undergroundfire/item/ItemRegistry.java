...
public class ItemRegistry
{
	...
	public static final RegistryObject<BlockItem> richCoalOre = ITEMS.register("rich_coal_ore", () -> new BlockItem(BlockRegistry.richCoalOre.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> burningRichCoalOre = ITEMS.register("burning_rich_coal_ore", () -> new BlockItem(BlockRegistry.burningRichCoalOre.get(), new Item.Properties()));
	public static final RegistryObject<BlockItem> gasTank = ITEMS.register("gas_tank", () -> new BlockItem(BlockRegistry.gasTank.get(), new Item.Properties()));
