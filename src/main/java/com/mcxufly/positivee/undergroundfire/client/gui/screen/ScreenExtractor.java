...
import com.mcxufly.positivee.undergroundfire.client.gui.menu.MenuExtractor;

public class ScreenExtractor extends AbstractContainerScreen<MenuExtractor>
{
	private static final ResourceLocation gui = new ResourceLocation(UndergroundFire.MODID, "textures/gui/extractor.png");
