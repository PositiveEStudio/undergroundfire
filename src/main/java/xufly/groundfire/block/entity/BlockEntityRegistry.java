...
public class BlockEntityRegistry
{
	...
	public static final RegistryObject<BlockEntityType<BlockEntityBurningRichCoalOre>> entityBlockBurningRichCoal = BLOCK_ENTITIES.register("burning_rich_coal_ore", () -> BlockEntityType.Builder.of(BlockEntityBurningRichCoalOre::new, BlockRegistry.burningCoalOre.get()).build(null));
}
