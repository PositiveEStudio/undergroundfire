...
public class BlockRegistry
{
	...
	public static final RegistryObject<LiquidBlock> coalGas = BLOCKS.register("coal_gas", () -> new LiquidBlock(FluidRegistry.coalGasSource, BlockBehaviour.Properties.of(Material.AIR, MaterialColor.NONE).strength(100F).noDrops()));
